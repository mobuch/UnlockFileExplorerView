...
In case of any errors, run the script in Debug mode and provide the log file to Marek_Obuchowski@spe.sony.com
Log file location: %appdata%\UnlockFileExplorerView_<version>.log